...
export function ProductsPage() {
  ...
  const canCreate = isAdmin || user?.cargo === "GERENTE" || user?.cargo === "SUPERVISOR"
    ...
    () => [
      {
        ...
        header: "Código",
        size: 120,
        cell: ({ row }) => <span className="text-muted-foreground">{row.original.codigo}</span>,
      },
      {
        accessorKey: "nome",
        header: "Nome",
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1">
        <h2 className="font-heading text-xl font-semibold tracking-tight">Gerenciamento de Produtos</h2>
        <p className="text-sm text-muted-foreground">Gerencie todos os produtos cadastrados no sistema.</p>
      </div>
